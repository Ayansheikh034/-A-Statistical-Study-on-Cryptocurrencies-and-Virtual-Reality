...
library(readxl)
library(tseries)
d=read_xlsx("D:\\ST 402 Project\\data\\metaverse tokens\\four tokens\\Decentraland.xlsx")
View(d)
dim(d)
par(mfrow=c(1,3))
plot(d$Date ,d$Return, type="l", xlab="Date", ylab="Return",
     main = "Decentraland return")
...
acf(d$Return, main="ACF of Decentraland")
pacf(d$Return, main="PACF of Decentraland")
